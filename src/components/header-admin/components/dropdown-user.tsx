        ...
        >
            ...
            >
                <span className="hidden text-right lg:block">
                    ...
                    <span className="block text-xs dark:text-white">{user?.role && rolesMap?.[user.role]}</span>
                </span>
                ...
                <span className="h-12 w-12 rounded-full">
                    <Image
                        width={112}
                        height={112}
                        src={'/default/default-mentor-img.png'}
                        style={{
                            width: 'auto',
                            height: 'auto',
                        }}
                ...
                <svg
                    className="hidden dark:fill-white fill-current sm:block"
                    width="12"
                    height="8"
                    viewBox="0 0 12 8"
                    fill="none"
                ...
                >
                    <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                        <li>
                            <Link
                                href="/profile"
                                className="flex dark:text-white items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                            >
                                <svg
                    ...
                    <button
                        ...
                        className="flex dark:text-white items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                    >
                        <svg
                            className="fill-current"
                            width="22"
